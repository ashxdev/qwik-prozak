    ...
    >
      <div class="card-img-overlay d-flex align-items-center p-3 p-sm-4">
        <div class="w-100 mt-auto">
          <a class="badge bg-success mb-2" href={`/${props.post?.attributes.category.data.attributes.slug}/${props.post?.attributes.slug}`}>
            <i class="fas fa-circle me-2 small fw-bold"></i>
            {props.post?.attributes.category.data.attributes.name}
          </a>
          <h4 class="text-white">
            <a href={`/${props.post?.attributes.category.data.attributes.slug}/${props.post?.attributes.slug}`} class="btn-link stretched-link text-reset">
